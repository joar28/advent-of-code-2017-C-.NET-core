...
class AdventOfCode_05
{
    ...
    public static class Cpu
    {
        ...
        public static int ProgCounterWeird(int[] arr)
        {
            var count = 0;
            int j;
            for (int i = 0; i < arr.Length; i += j)
